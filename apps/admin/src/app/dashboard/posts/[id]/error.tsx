...
export default function EditPostError({
  ...
  return (
    <div className="text-center py-20">
      ...
      <h2 className="text-lg font-semibold mb-2">Could not load this post</h2>
      <p className="text-gray-500 text-sm mb-6">Something went wrong while loading the editor.</p>
      <button
        onClick={reset}
